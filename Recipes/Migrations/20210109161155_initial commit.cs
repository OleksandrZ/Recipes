    ...
    public partial class initialcommit : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FollowedUsers", x => new { x.ObserverId, x.TargetId });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecipeFavorites", x => new { x.RecipeId, x.UserId });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CuisineId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    AuthorId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    Title = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Difficulty = table.Column<int>(type: "int", nullable: false),
                    Servings = table.Column<int>(type: "int", nullable: false),
                    TimeOfCooking = table.Column<TimeSpan>(type: "time", nullable: false),
                    NutrionValueId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    SiteVisits = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FollowedUsers_TargetId",
                table: "FollowedUsers",
                column: "TargetId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_FollowedUsers_AspNetUsers_ObserverId",
                table: "FollowedUsers",
                column: "ObserverId",
                principalTable: "AspNetUsers",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_FollowedUsers_AspNetUsers_TargetId",
                table: "FollowedUsers",
                column: "TargetId",
                principalTable: "AspNetUsers",
                principalColumn: "Id",
