...
namespace Recipes.Migrations
{
    ...
    [Migration("20210531075119_ChangeRecipe")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Recipes.Domain.RecipeLike", b =>
                {
                    b.Property<string>("LikedByUserId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("LikedRecipeId")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("LikedByUserId", "LikedRecipeId");

                    b.HasIndex("LikedRecipeId");
            ...
            modelBuilder.Entity("Recipes.Domain.AppUser", b =>
                {
                    ...
                    b.OwnsMany("Recipes.Domain.RefreshToken", "RefreshTokens", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int")
            ...
            modelBuilder.Entity("Recipes.Domain.Recipe", b =>
                {
                    ...
                    b.HasOne("Recipes.Domain.Photo", "MainImage")
                        .WithMany()
                        .HasForeignKey("MainImageId");

                    b.HasOne("Recipes.Domain.NutritionValue", "NutritionValue")
                        .WithMany()
            ...
            modelBuilder.Entity("Recipes.Domain.RecipeLike", b =>
                {
                    b.HasOne("Recipes.Domain.AppUser", "LikedByUser")
                        .WithMany("LikedRecipes")
                        .HasForeignKey("LikedByUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Recipes.Domain.Recipe", "LikedRecipe")
                        .WithMany("RecipeLikes")
                        .HasForeignKey("LikedRecipeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Recipes.Domain.Step", b =>
                {
                    b.HasOne("Recipes.Domain.Photo", "Image")
                        .WithMany()
